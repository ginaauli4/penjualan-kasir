            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center"
                   href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">SERBASERU <sup>SHOP</sup></div>
                </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <html lang="en">
                            ...
                            <body>
                                ...
                                <a href="tambah-toko.php"><button class="btn btn-primary">Tambah Toko</button></a>
...
?>
                                    <tr>
                                        ...
                                        <td><?= $d['created_at']?></td>
                                        <td>
                                            <a href="edit-toko.php?id_toko=<?= $d['id_toko']?>"><button
                                                        class="btn btn-primary">Edit</button></a>
                                            <a href="delete-toko.php?id_toko=<?= $d['id_toko']?>"
